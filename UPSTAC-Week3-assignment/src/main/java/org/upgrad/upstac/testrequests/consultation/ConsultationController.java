...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public List<TestRequest> getForDoctor() {
        ...
        // For reference check the method getForTests() method from LabRequestController class
        List<TestRequest> testList = testRequestQueryService.findByDoctor(user1);
        if (testList == null || testList.isEmpty()) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "requests assigned not present");
        }
...
//        throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            User user1 = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.assignForConsultation(id, user1);
            if (testRequest == null) {
                throw new AppException("unable to assign the test");
            }
            return testRequest;
            // replace this line of code with your implementation
//            throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
    ...
    public TestRequest updateConsultation(@PathVariable Long id, @RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            User user1 = userLoggedInService.getLoggedInUser();
            TestRequest testRequest = testRequestUpdateService.updateConsultation(id, testResult, user1);
            return testRequest;
            // replace this line of code with your implementation
//            throw new ResponseStatusException(HttpStatus.NOT_IMPLEMENTED,"Not implemented");
